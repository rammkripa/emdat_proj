...
author: "Nandini Ramesh & Ram M Kripa"
...
prec <- precip_data[[1]][,,709:1524]
tf <- attr(precip_data,"transforms")
image.plot(tf$lon$lon, rev(tf$lat$lat), prec[,rev(1:180),576],xlab="Longitude", ylab="Latitude")
# junk[ , rev(1:10), ]
...
```
```{r}
image.plot(tf$lon$lon, rev(tf$lat$lat), prec_anom[,rev(1:180),576],xlab="Longitude", ylab="Latitude")
...
cap_at_twenty <- function(vec_of_length_one) {
  if (is.na(vec_of_length_one)) {
    return(vec_of_length_one)
  }
  else if (vec_of_length_one > 20) {
    return(c(20))
  }
  else if (vec_of_length_one < (-20)) {
    return(c(-20))
...
prec_en_mean_changed <- apply(prec_en_mean, c(1, 2), cap_at_twenty)
prec_ln_mean_changed <- apply(prec_ln_mean, c(1, 2), cap_at_twenty)
prec_n_mean_changed <- apply(prec_n_mean, c(1, 2), cap_at_twenty)
image.plot(tf$lon$lon, rev(tf$lat$lat),prec_en_mean_changed[,rev(1:180)],xlab="Longitude", ylab="Latitude", col=RColorBrewer::brewer.pal(11, "BrBG"), zlim=c(-20,20), main="El Niño Precipitation Anomaly")
maps::map("world", add=TRUE, wrap = c(0, 360))
image.plot(tf$lon$lon, rev(tf$lat$lat),prec_ln_mean_changed[,rev(1:180)],xlab="Longitude", ylab="Latitude", col=RColorBrewer::brewer.pal(11, "BrBG"), zlim=c(-20,20), main="La Niña Precipitation Anomaly")
maps::map("world", add=TRUE, wrap = c(0, 360))
image.plot(tf$lon$lon, rev(tf$lat$lat),prec_n_mean_changed[,rev(1:180)],xlab="Longitude", ylab="Latitude", col=RColorBrewer::brewer.pal(11, "BrBG"), zlim=c(-20,20), main="Neutral Precipitation Anomaly")
maps::map("world", add=TRUE, wrap = c(0, 360))
```
```{r}
...
#par(mfrow = c(2,2))
image.plot(tf$lon$lon, rev(tf$lat$lat),prec_djf_en_mean[,rev(1:180)],xlab="Longitude", ylab="Latitude", col=RColorBrewer::brewer.pal(9, "BrBG"), zlim=c(-4,4), main="El Niño: DJF")
maps::map("world", add=TRUE, wrap = c(0, 360))
image.plot(tf$lon$lon, rev(tf$lat$lat),prec_mam_en_mean[,rev(1:180)],xlab="Longitude", ylab="Latitude", col=RColorBrewer::brewer.pal(9, "BrBG"), zlim=c(-4,4), main="El Niño: MAM")
maps::map("world", add=TRUE, wrap = c(0, 360))
image.plot(tf$lon$lon, rev(tf$lat$lat),prec_jja_en_mean[,rev(1:180)],xlab="Longitude", ylab="Latitude", col=RColorBrewer::brewer.pal(9, "BrBG"), zlim=c(-4,4),  main="El Niño: JJA")
maps::map("world", add=TRUE, wrap = c(0, 360))
image.plot(tf$lon$lon, rev(tf$lat$lat),prec_son_en_mean[,rev(1:180)],xlab="Longitude", ylab="Latitude", col=RColorBrewer::brewer.pal(9, "BrBG"), zlim=c(-4,4), main="El Niño: SON")
maps::map("world", add=TRUE, wrap = c(0, 360))
```
...
dev.new(width=100, height=60, unit="px")
par(mfrow = c(2,2))
image.plot(tf$lon$lon, rev(tf$lat$lat),prec_djf_ln_mean[,rev(1:180)],xlab="Longitude", ylab="Latitude", col=RColorBrewer::brewer.pal(9, "BrBG"), zlim=c(-4,4), main="La Niña: DJF")
maps::map("world", add=TRUE, wrap = c(0, 360))
image.plot(tf$lon$lon, rev(tf$lat$lat),prec_mam_ln_mean[,rev(1:180)],xlab="Longitude", ylab="Latitude", col=RColorBrewer::brewer.pal(9, "BrBG"), zlim=c(-4,4), main="La Niña: MAM")
maps::map("world", add=TRUE, wrap = c(0, 360))
image.plot(tf$lon$lon, rev(tf$lat$lat),prec_jja_ln_mean[,rev(1:180)],xlab="Longitude", ylab="Latitude", col=RColorBrewer::brewer.pal(9, "BrBG"), zlim=c(-4,4), main="La Niña: JJA")
maps::map("world", add=TRUE, wrap = c(0, 360))
image.plot(tf$lon$lon, rev(tf$lat$lat),prec_son_ln_mean[,rev(1:180)],xlab="Longitude", ylab="Latitude", col=RColorBrewer::brewer.pal(9, "BrBG"), zlim=c(-4,4), main="La Niña: SON")
maps::map("world", add=TRUE, wrap = c(0, 360))
```
...
dev.new(width=100, height=60, unit="px")
par(mfrow = c(2,2))
image.plot(tf$lon$lon, rev(tf$lat$lat),prec_djf_n_mean[,rev(1:180)],xlab="Longitude", ylab="Latitude", col=RColorBrewer::brewer.pal(9, "BrBG"), zlim=c(-4,4), main="Neutral: DJF")
maps::map("world", add=TRUE, wrap = c(0, 360))
image.plot(tf$lon$lon, rev(tf$lat$lat),prec_mam_n_mean[,rev(1:180)],xlab="Longitude", ylab="Latitude", col=RColorBrewer::brewer.pal(9, "BrBG"), zlim=c(-4,4), main="Neutral: MAM")
maps::map("world", add=TRUE, wrap = c(0, 360))
image.plot(tf$lon$lon, rev(tf$lat$lat),prec_jja_n_mean[,rev(1:180)],xlab="Longitude", ylab="Latitude", col=RColorBrewer::brewer.pal(9, "BrBG"), zlim=c(-4,4), main="Neutral: JJA")
maps::map("world", add=TRUE, wrap = c(0, 360))
image.plot(tf$lon$lon, rev(tf$lat$lat),prec_son_n_mean[,rev(1:180)],xlab="Longitude", ylab="Latitude", col=RColorBrewer::brewer.pal(9, "BrBG"), zlim=c(-4,4), main="Neutral: SON")
maps::map("world", add=TRUE, wrap = c(0, 360))
```